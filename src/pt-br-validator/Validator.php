...
namespace ConsultaAzul\PtBrValidator;
...
{
    /**
     * Valida o formato de celular com o ddd
     *
    ...
    /**
     * Valida o formato de telefone com o ddd
     *
     * @param string $attribute
     * @param string $value
     *
    ...
    /**
     * Valida o formato do celular sem ddd
     *
     * @param string $attribute
     * @param string $value
     *
    ...
    /**
     * Valida o formato do telefone sem ddd
     *
     * @param string $attribute
     * @param string $value
     *
    ...
    */
    ...
    /**
     * Valida o formato de placa de veículo
     *
     * @param string $attribute
     * @param string $value
     *
